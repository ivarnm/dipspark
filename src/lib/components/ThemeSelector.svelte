<script lang="ts">
	...
	let eclipse = THEMES.find((themeOption) => themeOption.value === 'halloween')
		? HalloweenEclipse
		: Eclipse;
...
<DropdownMenu>
	<svelte:component this={eclipse} slot="icon" />
			...
			>
				...
				>
					<circle
						...
						cy="12"
						r="7"
						fill={$theme === themeOption.value ? 'var(--primary-60)' : 'transparent'}
					/>
				</svg>
